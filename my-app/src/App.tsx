...
const sampleStudents: Student[] = [
  ...
  },
  {
    ...
    phone: "0905678901",
    address: "654 Đường Điện Biên Phủ, Q10, TP.HCM",
    gpa: 8.1
  }
];
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 text-center">
        ...
        <p className="text-2xl text-gray-600 mb-8">
          Hệ Thống Quản Lý Học Sinh Hiện Đại
        </p>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">
            Câu chuyện phát triển và sứ mệnh của chúng tôi
          </p>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {students.map((student) => (
            <div key={student.id} className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-all duration-200 hover:bg-gray-100">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <p><span className="font-medium">Tuổi:</span> {student.age}</p>
                ...
                <div className="flex items-center justify-between pt-2 border-t">
                  ...
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                    student.gpa >= 8.5 ? 'bg-green-100 text-green-700' :
                    student.gpa >= 7.0 ? 'bg-yellow-100 text-yellow-700' :
